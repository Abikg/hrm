...
let count = 1;
let dtoCount = 1;
$("#add-new-div").on("click",function(){
    let html = "<div class=\"form-group mt-2 p-3 work-experience-content_"+count+ "\"\>";
    ...
    html += " <label for=\"prevCompany\" class=\"col-form-label\">Previous Company</label>\n" +
            " <input type=\"text\" name=\"workExperienceDTO["+dtoCount+"\].previousCompany\" class=\"form-control\" id=\"prevCompany\">";
    html += "</div>";
    ...
    html +=     "<div class=\"form-group ml-0 ml-sm-auto\">\n" +
                ...
                "  </div>\n" +
                "  <input type=\"text\" class=\"form-control mydatepicker fromDate\" name=\"workExperienceDTO["+dtoCount+"\].joinDate\" data-date-format=\"yyyy/mm/dd\">\n" +
                "   </div>\n" +
                "   </div>\n" +
                ...
                "   <span class=\"input-group-text bg-transparent\" id=\"icon\"><i class=\"fas fa-calendar\"></i></span>\n" +
                "   </div>\n" +
                "   <input type=\"text\" class=\"form-control mydatepicker toDate\" name=\"workExperienceDTO["+dtoCount+"\].leftDate\" data-date-format=\"yyyy/mm/dd\">\n" +
                "   </div>\n" +
                "   </div>";
    html +=     "</div>";
